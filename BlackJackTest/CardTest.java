 ...
 *The PlayBlackJack class will have a main() method that calls the run() method of the CardTest class.
The CardTest class will run code that tests that your BJCard class was written correctly.
 * Lessons Learned:
 *   Hash maps
